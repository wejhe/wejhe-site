...
export default function ServiceOfferings() {
  return (
    <div className="flex flex-col items-center gap-[64px] w-full">
      <div className="px-body-padding-mobile lg:px-body-padding-desktop">
        <SectionTitle
          title="Service Offerings"
          subtitle="Exploring, shaping, and delivering digital solutions tailored to your unique needs"
        />
      </div>
      <div className="flex flex-col lg:flex-row bg-block-gray border-y border-stroke-gray items-center justify-center gap-[40px] w-full py-[40px] px-body-padding-mobile lg:px-body-padding-desktop">
