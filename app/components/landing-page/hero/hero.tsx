    ...
    <div className="flex flex-col items-center gap-[64px] w-full px-body-padding-mobile lg:px-body-padding-desktop">
      ...
      <div className="relative flex items-center justify-center w-full lg:w-[640px]">
        <input
          ...
          className="no-webkit-appearance bg-black placeholder-textual-gray focus:text-white border border-stroke-gray rounded-[8px] py-[16px] pl-[50px] pr-[180px] text-[16px] h-auto hover:border-stroke-gray-hover focus:border-stroke-gray-hover focus:shadow-[0_0_0_3px_#303030] outline-none w-full"
        />
        <Image
          src="/idea.svg"
          width={24}
